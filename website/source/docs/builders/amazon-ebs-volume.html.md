...
Here is a basic example, which will create 3 EBS volumes, and create a ZFS 
zpool with a single raidz vdev. It uses the latest Ubuntu Xenial AMI for the source
instance.
	...
	"provisioners": [
		{
			...
			"inline": [
				...
				"lsblk",
				"echo 'Creating GPT partition labels on each volume...'",
...
-&gt; **Note:** This example is not supposed to serve as an example for best
practice configuration of ZFS. Please refer to the documentation for your operating
system distribution for settings which meet your redundancy and performance
requirements.
