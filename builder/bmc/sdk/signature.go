// This is a golang implementation of the http-signatures spec
...
func (h HeaderList) signingString(req *http.Request) (string, error) {
	...
	for _, header := range h {
		...
		if header == RequestTarget {
			fmt.Println("TTTTTTTTTTTTTTTTTTTTTTT")
			fmt.Println(requestTargetLine(req))
			fmt.Println("TTTTTTTTTTTTTTTTTTTTTTT")
